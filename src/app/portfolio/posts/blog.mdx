...
You can create, edit and delete posts by adding, modifying or removing `*.mdx` files in the `src/app/portfolio/posts` directory.
...
---`,
        language: "tsx",
        label: "src/app/portfolio/posts/post-1.mdx"
      }
    ]}
/>
